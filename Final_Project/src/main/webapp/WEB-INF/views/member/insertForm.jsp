					...
					<div class="row_group">
						...
						<div class="join_row">
							...
							<div class="alert alert-danger" id="alert-danger"
								style="color: #FF0000;">비밀번호가 일치하지 않습니다.</div>
						</div>
					</div>
					...
					<div class="row_group">
						<div class="join_row">
							...
							<span class="ps_box box_right_space"> 
								<input type="text" id="memName" name="memName" title="이름" class="int" maxlength="10" placeholder="2~6자의 한글만 입력">
							</span> 
						...
						<div class="join_row join_mobile">
							...
							<div class="int_mobile_area">
								...
								<a href="#" class="btn_verify btn_primary" id="btnSend"
									role="button" onclick="sample6_execDaumPostcode()"> 
