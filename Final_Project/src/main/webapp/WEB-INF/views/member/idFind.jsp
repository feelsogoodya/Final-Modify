...
<body>
	<form action="${pageContext.request.contextPath }/member/searchId"
		commandName="searchVO" id="createForm" method="post">
					...
					<div class="login_wrap">
						<ul class="menu_wrap" role="tablist">
							<li class="menu_item" role="presentation"><a href="idFind"
								id="loinid" class="menu_id on" role="tab" aria-selected="true">
									<span class="menu_text"> <span class="text">아이디
											찾기</span></span>
							</a>
							<li class="menu_item" role="presentation"><a href="passFind"
								id="ones" class="menu_ones" role="tab" aria-selected="false">
								...
								<div class="panel_inner" role="tabpanel" aria-controls="loinid">
									<div class="input_row" id="id_line">
										<input type="text" id="memName" name="memName"
											placeholder="이름" class="input_text"
											style="text-align: center;">
									</div>
									<div class="input_row" id="pw_line">
										<input type="text" id="memPhone" name="memPhone"
											placeholder="전화번호" class="input_text"
											style="text-align: center;">
									</div>
