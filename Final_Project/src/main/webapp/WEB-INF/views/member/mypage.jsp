			...
			<div class="header_subindex">
				<div class="card">
					...
					<div id="headerLeft" class="header_left">
						...
						<ul class="left_link">
							<li><a href="${pageContext.request.contextPath }/list/buylist" class="left_item">
							...
							<ul class="subindex_row">
								<li>
									<div id="phoneNoRegDiv" class="row_item name ">
										<input type="text" id="memName" name="memName" title="이름"
											class="int" value="${dto.memName }" maxlength="10"
											placeholder="2~6자의 한글만 입력" style="width: 550px;">
										<button type="submit" class="btn_edit">
								...
								<li>
									<div class="row_item lock">
										<input type="password" id="memPass" name="memPass" class="int"
											...
											value="${dto.memPass }" placeholder="4~12자의 영문 대소문자와 숫자로만 입력"
								...
								<li>
									<div class="row_item mail ">
										<input type="text" id="memEmail" name="memEmail"
											aria-label="선택입력" value="${dto.memEmail }" class="int"
											maxlength="100" placeholder="ex)...@naver.com"
											style="width: 550px;">
										<button type="submit" class="btn_edit">
											<span class="text">수정</span>
										</button>
								...
								<li>
									<div id="phoneNoRegDiv" class="row_item phone ">
										<input type="text" id="memPhone" name="memPhone"
											placeholder="전화번호 입력" value="${dto.memPhone }"
								...
								<li>
									<div id="phoneNoRegDiv" class="row_item other ">
										<input type="text" id="sample6_address" name="memAddress"
											placeholder="상세주소" class="int" value="${dto.memAddress }"
											style="width: 400px;"> 
										<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"
											class="d_btn"> <span></span> 
										<input type="text" id="sample6_extraAddress" name="memAddress" class="int"
											placeholder="상세주소" style="width: 550px;">
										<button type="submit" class="btn_edit">
											<span class="text">수정</span>
										</button>
									</div>
